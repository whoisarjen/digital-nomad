...
2. IDEA-15 (City Tips) has been live for at least 3 months to establish UGC culture
3. IDEA-11 (Check-ins) is live to provide a community signal
...
**Consider IDEA-15 as the substitute:** City Tips (short, categorized, upvoteable) covers 80% of the Q&A use case with significantly lower moderation burden. Build IDEA-15 first and assess whether a full forum is still needed.

**If building:**
- The 6-month auto-expire on threads is a good design — prevents stale questions from cluttering the page
- Email notifications on replies are table stakes — requires IDEA-14 (Newsletter/Resend) infrastructure first
...
- Email notification on reply (via Resend, requires IDEA-14)

## Dependencies
- **BLOCKED until 500+ active users**
- IDEA-15 (City Tips) — build and validate first; may obviate forum need
- IDEA-14 (Newsletter/Resend) — required for email notifications
- IDEA-11 (Check-ins) — provides community signal prerequisite

## Notes
- Do not start implementation until the traffic/user gate is met.
- Consider IDEA-15 as a permanent substitute rather than a stepping stone.
