# IDEA-03: "Pack for This City" Practical Info
**Status:** NOT_STARTED
**Priority:** 03/23
**Complexity:** S
...
**Linking to country pages** (IDEA-09): country pages would show this info prominently. City pages just show it as a utility widget.
...
## Dependencies
- IDEA-09 (Country Pages): practical info displays prominently on country detail pages once those exist.
