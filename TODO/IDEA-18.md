...
**Schema compatibility with IDEA-16:** Both `CityTip` and `CityReview` go on the city page. Keep them as separate sections — tips are practical advice, reviews are subjective opinions.
...
## Dependencies
- IDEA-19 (Public Profiles): reviews authored by a user appear on their profile.
