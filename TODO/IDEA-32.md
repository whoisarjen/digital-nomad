...
- `Favorite` model exists (IDEA-20 adds status)
...
1. Favorite cities (already exists — VISITED/PLANNING from IDEA-20) — minimum viable content
2. Tips submitted (IDEA-15)
3. Reviews submitted (IDEA-31)
4. Check-in history (IDEA-11)
...
## Dependencies
- IDEA-20 (Favorites Split): VISITED cities are the primary public content. Required.
- IDEA-15 (Tips): tip count/list on profile — optional, add later.
- IDEA-31 (Reviews): review count on profile — optional, add later.
...
- Link to profile from tip and review author bylines once IDEA-15 and IDEA-31 are built.
